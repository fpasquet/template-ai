...
import { ButtonGroup, ButtonGroupText } from '@monorepo/ui/components/button-group';
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      `
        group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-4
        ...
        <>
          ...
          {onRemove && (
            <Button
              ...
              className={`
                absolute top-2 right-2 size-6 rounded-full bg-background/80 p-0 opacity-0 backdrop-blur-sm
                transition-opacity
        ...
        <>
          ...
          {onRemove && (
            <Button
              aria-label="Remove attachment"
              className={`
                size-6 shrink-0 rounded-full p-0 opacity-0 transition-opacity
                group-hover:opacity-100
                hover:bg-accent
                [&>svg]:size-3
              `}
