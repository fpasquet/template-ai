...
import { HoverCard, HoverCardContent, HoverCardTrigger } from '@monorepo/ui/components/hover-card';
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupTextarea } from '@monorepo/ui/components/input-group';
    ...
    <PromptInputHoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            `
              group relative flex h-8 cursor-pointer items-center gap-1.5 rounded-md border border-border px-1.5 text-sm
